...
CORS(app, resources={r"/chat": {"origins": ["http://localhost:5000", "http://localhost:3000", "http://localhost:5173","https://frontend-movie-dwiv-29qt9z7hw-sanchos-projects-d560820c.vercel.app"]}})
